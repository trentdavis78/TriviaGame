$(document).ready(function () {
    ...
    var intervalId,
        ...
        questionsAnswered = 0,
        streak = 0,
        categories = ["entertainment", "general", "movies", "sports", "music", "geography", "instruments", "famous_dates"],
    ...
    // write categories to the home page using the uniqueRandom function
    ...
    // replace db categories that have underscores with spaces
    ...
    // reset all CSS and prep for new round -or- end the game
    ...
    // remove previously selected category from unique random array
